REPO = http://gitlab.quvideo.com/WEB/viva-tools-issue.git
...
upload-dev:
	@npx f2e-uploader -d dev/vcm/viva-tools/issue/dist -l dist -p

upload-daily:
	@npx f2e-uploader -d daily/vcm/viva-tools/issue/dist -l dist -p

upload-prod:
	@npx f2e-uploader -d prod/vcm/viva-tools/issue/dist -l dist -p
