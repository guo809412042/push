      ...
      <Collapse defaultActiveKey={['1']}>
        <Panel header={<FormattedMessage id="common.search" defaultMessage="查询" />} key="1">
          <Form layout="inline" onSubmit={this.handleSubmit}>
            ...
            <FormItem label="完结原因" className={styles.marginPxForItem}>
              {getFieldDecorator('completeReason', {
                initialValue: '',
              })(
                <Select allowClear style={{ width: 100 }}>
                  {Object.keys(ISSUE_CLOSE_REASON).map(k => <Option key={k} value={k}>{ISSUE_CLOSE_REASON[k]}</Option>)}
                </Select>,
              )}
            </FormItem>
